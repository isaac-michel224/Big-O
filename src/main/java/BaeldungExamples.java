public class BaeldungExamples {
    ...
    is understanding the rates at which things can grow.
    ...
    public static void constantTime(int n) {
        ...
        despite taking three time as long to run.
    ...
    //polynomial describes times that are quadratic(n^2), cubic(n^3), quartic(n^4), quartic(n^5)
